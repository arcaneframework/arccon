...
function(arccon_dotnet_install_publish_directory)
  ...
  if (NOT ARGS_DIRECTORY)
    message(FATAL_ERROR "In ${_func_name}: DIRECTORY not specified")
  endif()
  if (NOT ARGS_DESTINATION)
    message(FATAL_ERROR "In ${_func_name}: DESTINATION not specified")
  endif()
...
function(arccon_add_csharp_target target_name)
  ...
  if (NOT target_name)
    message(FATAL_ERROR "In ${_func_name}: no 'target_name' specified")
  endif()
  if (NOT ARGS_DOTNET_RUNTIME)
    message(FATAL_ERROR "In ${_func_name}: DOTNET_RUNTIME not specified")
  endif()
  if (NOT ${ARGS_DOTNET_RUNTIME} MATCHES "coreclr|mono")
    message(FATAL_ERROR "In ${_func_name}: Invalid value '${ARGS_DOTNET_RUNTIME}' for DOTNET_RUNTIME. Valid values are 'coreclr' or 'mono'")
  endif()
  if (NOT ARCCON_DOTNET_HAS_RUNTIME_${ARGS_DOTNET_RUNTIME})
    message(FATAL_ERROR "In ${_func_name}: Requested runtime '${ARGS_DOTNET_RUNTIME}' is not available")
  endif()
  if (NOT ARGS_BUILD_DIR)
    message(FATAL_ERROR "In ${_func_name}: BUILD_DIR not specified")
  endif()
  if (NOT ARGS_ASSEMBLY_NAME)
    message(FATAL_ERROR "In ${_func_name}: ASSEMBLY_NAME not specified")
  endif()
  if (NOT ARGS_PROJECT_PATH)
    message(FATAL_ERROR "In ${_func_name}: PROJECT_PATH not specified")
  endif()
  if (NOT ARGS_PROJECT_NAME)
    message(FATAL_ERROR "In ${_func_name}: PROJECT_NAME not specified")
  endif()
  ...
  if (NOT _msbuild_exe)
    message(FATAL_ERROR "In ${_func_name}: 'msbuild' command for runtime '${ARGS_DOTNET_RUNTIME}' is not available.")
  endif()
